      ...
      <AnimatePresence>
        {selectedProductDetail && (
          <div className="fixed inset-0 z-[998] flex items-center justify-end">
            ...
            >
              {/* Detail Header */}
              <div className="px-6 sm:px-8 pt-[calc(env(safe-area-inset-top)+16px)] pb-4 sm:py-6 border-b border-slate-100 flex items-center justify-between bg-white sticky top-0 z-20">
                <button 
                  onClick={() => {
